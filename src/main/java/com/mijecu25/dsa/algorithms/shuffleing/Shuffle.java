...
public final class Shuffle {
	...
	/**
	 * Randomly shuffle the elements in an array using a modern version of the 
	 ...
	 */
	public static void fyShuffle(Object[] array) {
		Object hold = null;
	...
	/**
	 * Randomly shuffle an int array using a modern version of the 
	 * Fisher–Yates shuffle.
	 * 
	 * <br>
	 * <br>
	 ...
	 */
	public static void fyShuffle(int[] intArray) {
	...
	/**
	 * Randomly shuffle an float array using a modern version of the 
	 * Fisher–Yates shuffle.
	 * 
	 * <br>
	 * <br>
	 ...
	 */
	public static void fyShuffle(float[] floatArray) {
	...
	/**
	 * Randomly shuffle an byte array using a modern version of the 
	 * Fisher–Yates shuffle.
	 * 
	 * <br>
	 * <br>
	 ...
	 */
	public static void fyShuffle(byte[] byteArray) {
	...
	/**
	 * Randomly shuffle an short array using a modern version of the 
	 * Fisher–Yates shuffle.
	 * 
	 * <br>
	 * <br>
	 ...
	 */
	public static void fyShuffle(short[] shortArray) {
	...
	/**
	 * Randomly shuffle an long array using a modern version of the 
	 * Fisher–Yates shuffle.
	 * 
	 * <br>
	 * <br>
	 ...
	 */
	public static void fyShuffle(long[] longArray) {
	...
	/**
	 * Randomly shuffle an double array using a modern version of the 
	 * Fisher–Yates shuffle.
	 * 
	 * <br>
	 * <br>
	 ...
	 */
	public static void fyShuffle(double[] doubleArray) {
	...
	/**
	 * Randomly shuffle a char array using a modern version of the 
	 * Fisher–Yates shuffle.
	 * 
	 * <br>
	 * <br>
	 ...
	 */
	public static void fyShuffle(char[] charArray) {
